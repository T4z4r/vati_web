...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'branch.access'])->group(function () {
        ...
        Route::get('loan-applications/{loanApplication}/documents/{loanDocument}/download', [ApplicationDocumentController::class, 'download'])->name('api.loan-applications.documents.download')->middleware('permission:view-loan-applications');
        ...
        Route::get('loans/{loan}/export', [LoanExportController::class, 'download'])->middleware('permission:view-loans');
