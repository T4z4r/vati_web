...
class VatCorrectionTest extends TestCase
{
    ...
    public function test_correct_updates_figures_and_regenerates_schedule(): void
    {
        ...
        $this->assertAmount(1000000, $application->calc_total_repayment, 'application calc_total_repayment');
        $this->assertAmount(0, $application->calc_interest, 'application calc_interest');
