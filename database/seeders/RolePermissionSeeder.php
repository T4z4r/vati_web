...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            'view-dashboard', 'manage-organization', 'view-users', 'manage-users',
            'view-members', 'create-members', 'edit-members', 'delete-members',
            'view-groups', 'create-groups', 'edit-groups', 'view-loan-products', 'manage-loan-products',
        ...
        Role::findByName('loan_officer')->syncPermissions(['view-dashboard', 'view-members', 'create-members', 'edit-members', 'view-groups', 'view-loan-products', 'view-loan-applications', 'create-loan-applications', 'view-loans', 'view-payments', 'collect-payments', 'view-security']);
        ...
        Role::findByName('credit_officer')->syncPermissions(['view-dashboard', 'view-members', 'view-loan-products', 'view-loan-applications', 'review-loan-applications', 'approve-loan-applications', 'reject-loan-applications', 'view-loans']);
