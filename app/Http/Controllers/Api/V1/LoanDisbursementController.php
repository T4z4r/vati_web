...
class LoanDisbursementController extends ApiController
{
    public function store(Request $request, Loan $loan, DisbursementService $service)
    {
        ...
        $data = $request->validate(['method' => ['required', Rule::in(['cash', 'mpesa', 'airtel_money', 'mixx', 'halopesa', 'bank_transfer'])], 'recipient_number' => ['nullable', 'string', 'max:30'], 'bank_account' => ['nullable', 'string', 'max:100'], 'reference_number' => ['nullable', 'string', 'max:100'], 'provider_reference' => ['nullable', 'string', 'max:100'], 'issued_date' => ['nullable', 'date'], 'disbursed_at' => ['nullable', 'date']]);
