...
class LoanProductController extends ApiController
{
    ...
    {
        return $request->validate(['name' => ['required', 'max:150'], 'minimum_amount' => ['required', 'numeric', 'min:0'], 'maximum_amount' => ['required', 'numeric', 'gte:minimum_amount'], 'minimum_duration_months' => ['required', 'integer', 'min:1'], 'maximum_duration_months' => ['required', 'integer', 'gte:minimum_duration_months'], 'annual_interest_rate' => ['required', 'numeric', 'min:0', 'max:100'], 'interest_method' => ['required', Rule::in(['flat', 'reducing_balance'])], 'repayment_frequency' => ['required', Rule::in(['weekly', 'monthly'])], 'security_percentage' => ['nullable', 'numeric', 'min:0', 'max:100'], 'processing_fee_percentage' => ['nullable', 'numeric', 'min:0', 'max:100'], 'insurance_percentage' => ['nullable', 'numeric', 'min:0', 'max:100'], 'vat_percentage' => ['nullable', 'numeric', 'min:0', 'max:100'], 'required_group_witnesses' => ['sometimes', 'integer', 'min:0', 'max:20'], 'status' => ['sometimes', 'boolean']]);
    }
}
