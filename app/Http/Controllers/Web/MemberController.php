...
class MemberController extends Controller
{
    ...
    public function update(Request $request, Member $member, GroupMembershipService $memberships)
    {
        ...
        $data = $request->validate([
            ...
            'permanent_postal_address' => ['nullable', 'string', 'max:100'],
            'permanent_police_station' => ['nullable', 'string', 'max:150'],
            ...
            'business_work_area' => ['nullable', 'string', 'max:200'],
            'has_vati_family_member' => ['nullable', 'boolean'],
            'vati_family_member_name' => ['nullable', 'string', 'max:150'],
            'family_member_is_group_member' => ['nullable', 'boolean'],
            ...
            'kyc.current_house_number' => ['nullable', 'string', 'max:100'],
            'kyc.current_area' => ['nullable', 'string', 'max:100'],
            'kyc.current_street' => ['nullable', 'string', 'max:100'],
            'kyc.current_postal_address' => ['nullable', 'string', 'max:100'],
            'kyc.current_police_station' => ['nullable', 'string', 'max:150'],
            'kyc.current_district' => ['nullable', 'string', 'max:100'],
            'kyc.current_region' => ['nullable', 'string', 'max:100'],
    ...
    {
        $data = $request->validate([
            'mpesa_phone' => ['nullable', 'max:20'],
            'bank_account_number' => ['nullable', 'max:100'],
            'bank_account_name' => ['nullable', 'max:150'],
            'bank_name' => ['nullable', 'max:150'],
            'house_number' => ['nullable', 'max:100'],
            'police_station' => ['nullable', 'max:150'],
            'current_house_number' => ['nullable', 'max:100'],
            'current_area' => ['nullable', 'max:100'],
            'current_street' => ['nullable', 'max:100'],
            'current_postal_address' => ['nullable', 'max:100'],
            'current_police_station' => ['nullable', 'max:150'],
            'current_district' => ['nullable', 'max:100'],
            'current_region' => ['nullable', 'max:100'],
            'business_name' => ['nullable', 'max:150'],
            'business_type' => ['nullable', 'max:150'],
            'business_address' => ['nullable', 'string'],
            'household_monthly_income' => ['nullable', 'numeric', 'min:0'],
            'household_monthly_expenses' => ['nullable', 'numeric', 'min:0'],
            'number_of_dependants' => ['nullable', 'integer', 'min:0'],
            'head_of_household' => ['nullable', 'max:150'],
            'house_ownership_status' => ['nullable', 'max:100'],
        ]);
