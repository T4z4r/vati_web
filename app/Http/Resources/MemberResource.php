...
class MemberResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'permanent_house_number' => $this->permanent_house_number,
            'permanent_area' => $this->permanent_area,
            'permanent_street' => $this->permanent_street,
            'permanent_postal_address' => $this->permanent_postal_address,
            ...
            'ward' => $this->ward,
            'street' => $this->street,
            'business_work_area' => $this->business_work_area,
            'has_vati_family_member' => (bool) $this->has_vati_family_member,
            'vati_family_member_name' => $this->vati_family_member_name,
            'family_member_is_group_member' => (bool) $this->family_member_is_group_member,
            'group_family_member_name' => $this->group_family_member_name,
