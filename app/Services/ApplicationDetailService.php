...
class ApplicationDetailService
{
    ...
    public function build(LoanApplication $application): array
    {
        ...
        return [
            ...
            'application_date' => $application->application_date?->toDateString() ?? $application->created_at?->toDateString(),
            'expected_disbursement_date' => $application->expected_disbursement_date?->toDateString(),
            ...
            'insurance_fee' => $this->money($figures['insurance_fee']),
            'vat' => $this->money($figures['vat']),
            ...
            'assessment' => [
                ...
                'external_lender_name' => $application->assessment?->external_lender_name,
                'external_loan_total_amount' => $this->money($application->assessment?->external_loan_total_amount),
                'external_loan_outstanding_amount' => $this->money($application->assessment?->external_loan_outstanding_amount),
    ...
    private function member(LoanApplication $application): array
    {
        ...
        return [
            ...
            'permanent_house_number' => $member->permanent_house_number,
            'permanent_area' => $member->permanent_area,
            'permanent_street' => $member->permanent_street,
            'permanent_postal_address' => $member->permanent_postal_address,
            'permanent_police_station' => $member->permanent_police_station,
            'permanent_district' => $member->permanent_district,
            'permanent_region' => $member->permanent_region,
            'region' => $member->region,
            'district' => $member->district,
            'ward' => $member->ward,
            'street' => $member->street,
            'business_work_area' => $member->business_work_area,
            'has_vati_family_member' => (bool) $member->has_vati_family_member,
            'vati_family_member_name' => $member->vati_family_member_name,
            'family_member_is_group_member' => (bool) $member->family_member_is_group_member,
            'group_family_member_name' => $member->group_family_member_name,
            ...
            'kyc' => [
                ...
                'current_house_number' => $member->kyc?->current_house_number,
                'current_area' => $member->kyc?->current_area,
                'current_street' => $member->kyc?->current_street,
                'current_postal_address' => $member->kyc?->current_postal_address,
                'current_police_station' => $member->kyc?->current_police_station,
                'current_district' => $member->kyc?->current_district,
                'current_region' => $member->kyc?->current_region,
