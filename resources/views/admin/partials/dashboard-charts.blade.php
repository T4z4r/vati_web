...
<div class="charts-grid">
    <div class="card chart-card">
        <div class="card-head">
            <h2>{{ __('Collections trend (last 14 days)') }}</h2>
        </div>
        <div class="card-body"><canvas id="chart-collections-trend"></canvas></div>
    </div>
    <div class="card chart-card">
        <div class="card-head">
            <h2>{{ __('Loan status breakdown') }}</h2>
        </div>
        <div class="card-body">
            @if (empty($loanStatus['labels']))
                <p class="muted">{{ __('No chart data available yet.') }}</p>
            @else
